...
export default function FileSend({ onImageSelect, onVideoSelect, onFileSelect, isVisible }) {
  return (
    <div className={`w-28 h-36 bg-[#200F2F] rounded-md flex flex-col divide-y divide-gray-700 absolute bottom-20 left-1/2 sm:-translate-x-[175%] -translate-x-[150%] z-50 ${isVisible ? "block" : "hidden"}`}>
